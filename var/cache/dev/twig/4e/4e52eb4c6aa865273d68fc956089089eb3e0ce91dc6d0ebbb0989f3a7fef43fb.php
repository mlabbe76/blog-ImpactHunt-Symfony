...
class __TwigTemplate_15b9918da14af989f1defa375cfcc6374ef6bb3c607d15b05ec1465eb7a533d3 extends Template
{
    private $source;
    private $macros = [];
...
\t\t<h1>";
        // line 8
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Inscription", [], "global");
        echo "</h1>
\t\t";
        // line 9
...
{% block title %}ImpactHunt - Inscription{% endblock %}

{% block body %}

    <div class=\"col-4 mt-3\">
\t\t<h1>{% trans from 'global' %}Inscription{% endtrans %}</h1>
\t\t{{ form(form) }}
\t</div>

{% endblock %}
", "register/index.html.twig", "C:\\xampp\\htdocs\\Blog-ImpactHunt-Symfony\\templates\\register\\index.html.twig");
    }
}
